...
public class MainActivity extends Activity {
    ...
    private TextView mTvRawText;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        mTvRawText = findViewById(R.id.tv_raw_text);
    ...
    private void handle(Intent intent) {
        ...
        parseToRawTextAsync(url);
    }

    private void parseToRawTextAsync(String url) {
        new AsyncTask<String, Void, String>() {

            @Override
            protected String doInBackground(String... params) {
                return parseToRawText(params[0]);
            }

            @Override
            protected void onPostExecute(String rawText) {
                Log.d("rawText: " + rawText);
                mTvRawText.setText(rawText);
    ...
    private String parseToRawText(String url) {
        final Document document;
        try {
            document = Jsoup.parse(new URL(url), 15_000);
            final Elements elements = document.select("div#js_content");
            if (elements.isEmpty()) {
                return null;
            }
            ...
            Log.w("parseToRawText error: " + url, e);
